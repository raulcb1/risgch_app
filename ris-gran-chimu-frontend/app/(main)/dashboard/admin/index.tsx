// app/(main)/dashboard/admin/index.tsx
  ...
  const options = [
    {
      ...
      description: 'Crear, editar, eliminar y ver usuarios del sistema',
      icon: Users,
      onPress: () => router.push('./admin/users'),
      color: '#007AFF',
    },
    {
      label: 'Gestionar Rols',
      description: 'Crear y configurar roles y permisos del sistema',
      icon: Shield,
      onPress: () => router.push('./manage/roles'),
      color: '#FF9500',
    },
    {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>Panel de Administración - RIS Gran Chimu</Text>
      </View>
    </ScrollView>
  );
}
